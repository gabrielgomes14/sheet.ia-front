...
var OrdinalTimeAxis = class extends import_ag_charts_community8._ModuleSupport.CategoryAxis {
  ...
  updateScale() {
    ...
    this.minGranularity = minimumTimeAxisDatumGranularity(boundSeries, direction, void 0, void 0);
  }
  ...
  datumFormatParams(value, params, _fractionDigits, timeInterval, style) {
    ...
    if (timeInterval == null) {
      ...
      if (minGranularity != null && intervalMilliseconds(minGranularity) < intervalMilliseconds(datumGranularity)) {
...
var initialStateOptionsDef = {
  ...
  zoom: {
    ...
    ratioX: {
      start: (0, import_ag_charts_core10.and)(import_ag_charts_core10.ratio, (0, import_ag_charts_core10.lessThan)("end")),
      end: (0, import_ag_charts_core10.and)(import_ag_charts_core10.ratio, (0, import_ag_charts_core10.greaterThan)("start"))
    },
    ratioY: {
      start: (0, import_ag_charts_core10.and)(import_ag_charts_core10.ratio, (0, import_ag_charts_core10.lessThan)("end")),
      end: (0, import_ag_charts_core10.and)(import_ag_charts_core10.ratio, (0, import_ag_charts_core10.greaterThan)("start"))
...
var BoxPlotSeries = class extends import_ag_charts_community27._ModuleSupport.AbstractBarSeries {
  ...
  getTooltipContent(datumIndex) {
    ...
    return this.formatTooltipWithContext(
      tooltip,
      {
        heading: xAxis.formatDatum(xValue2, "tooltip", seriesId, legendItemName, datum, xKey),
  ...
  updateDatumNodes({
    ...
    datumSelection.each((boxPlotGroup, nodeDatum) => {
      ...
      activeStyles = mergeDefaults2(highlightStyle, activeStyles);
  ...
  series: {
    ...
    fill: {
      $if: [
        ...
        { $palette: "fill" },
        { $mix: [import_ag_charts_community29._ModuleSupport.SAFE_FILL_OPERATION, { $ref: "chartBackgroundColor" }, 0.7] }
      ]
    },
...
var { BaseProperties: BaseProperties3, Property: Property14, AbstractBarSeriesProperties: AbstractBarSeriesProperties2, makeSeriesTooltip: makeSeriesTooltip2 } = import_ag_charts_community35._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeriesProperties.ts
var { FillGradientDefaults: FillGradientDefaults2, FillPatternDefaults: FillPatternDefaults2, FillImageDefaults: FillImageDefaults2, BaseProperties: BaseProperties4, makeSeriesTooltip: makeSeriesTooltip3, Property: Property15 } = import_ag_charts_community36._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeriesProperties.ts
var { CartesianSeriesProperties, makeSeriesTooltip: makeSeriesTooltip4, Property: Property17 } = import_ag_charts_community43._ModuleSupport;
...
var HeatmapSeries = class extends import_ag_charts_community44._ModuleSupport.CartesianSeries {
  ...
  createNodeData() {
    ...
    rawData.forEach((datum, datumIndex) => {
      ...
      const labelText = colorValue == null ? void 0 : this.getLabelText(
        colorValue,
        datum,
        colorKey,
        "color",
    ...
    data.push(
      {
        label: xName,
        fallbackLabel: xKey,
        value: xAxis.formatDatum(xValue2, "tooltip", seriesId, legendItemName, datum, xKey)
      },
      {
        label: yName,
        fallbackLabel: yKey,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, heatmapSeriesThemeableOptionsDef, without } = import_ag_charts_community45._ModuleSupport;
...
var HEATMAP_SERIES_THEME = {
  series: {
    ...
    itemPadding: 3,
    highlight: import_ag_charts_community46._ModuleSupport.singleSeriesHighlightStyle()
  },
  gradientLegend: {
    enabled: true
  }
...
var { createDatumId: createDatumId5, applyShapeStyle: applyShapeStyle3 } = import_ag_charts_community48._ModuleSupport;
var OhlcSeries = class extends OhlcSeriesBase {
  ...
  updateDatumNodes({
    ...
    datumSelection.each((node, datum) => {
      ...
      node.crisp = crisp;
      const highlightStyle = this.getHighlightStyle(isHighlight, datum.datumIndex);
      applyShapeStyle3(node, {
        stroke: highlightStyle?.stroke ?? style?.stroke ?? (isRising ? upStroke : downStroke),
        strokeWidth: highlightStyle?.strokeWidth ?? style?.strokeWidth ?? (isRising ? upStrokeWidth : downStrokeWidth),
        strokeOpacity: highlightStyle?.strokeOpacity ?? style?.strokeOpacity ?? (isRising ? upStrokeOpacity : downStrokeOpacity),
        lineDash: highlightStyle?.lineDash ?? style?.lineDash ?? (isRising ? upLineDash : downLineDash),
        lineDashOffset: highlightStyle?.lineDashOffset ?? style?.lineDashOffset ?? (isRising ? upLineDashOffset : downLineDashOffset),
        opacity: highlightStyle?.opacity ?? 1
      });
...
var RangeAreaSeries = class extends import_ag_charts_community53._ModuleSupport.CartesianSeries {
  ...
  updatePathNodes(opts) {
    ...
    const {
      ...
      fillOpacity,
      opacity
    } = mergeDefaults3(this.getHighlightStyle(), this.properties);
  ...
  getMarkerItemBaseStyle(isHighlight, datum) {
    const { properties } = this;
  ...
  updateMarkerNodes(opts) {
    ...
    markerSelection.each((node, datum) => {
      const baseStyle = mergeDefaults3(this.getHighlightStyle(isHighlight, datum?.datumIndex), markerStyle, {
        fill,
        fillOpacity,
        stroke,
        strokeWidth,
...
var RangeBarSeries = class extends import_ag_charts_community58._ModuleSupport.AbstractBarSeries {
  ...
  createNodeData() {
    ...
    if (dataAggregationFilter != null) {
      ...
      let [start, end] = visibleRangeIndices2(1, rawData.length, xAxis.range, (index) => {
        const x = xPosition(index);
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    highlight: import_ag_charts_community60._ModuleSupport.multiSeriesHighlightStyle()
  },
  axes: {
...
var WaterfallSeries = class extends import_ag_charts_community63._ModuleSupport.AbstractBarSeries {
  ...
  getItemStyle(datumId, datum, itemId, isHighlight, nodeDatum) {
    const { id: seriesId, properties } = this;
    ...
    if (itemStyler != null) {
      let itemStyle = this.cachedDatumCallback(createDatumId8(datumId, isHighlight ? "highlight" : "node"), () => {
        return this.callWithContext(itemStyler, {
          seriesId,
          itemId,
          datum,
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      applyShapeStyle6(rect, style, void 0, fillBBox);
      rect.visible = categoryAlongX ? datum.width > 0 : datum.height > 0;
      rect.crisp = datum.crisp;
    });
  }
...
var WATERFALL_SERIES_THEME = {
  series: {
    ...
    highlight: import_ag_charts_community65._ModuleSupport.singleSeriesHighlightStyle()
  },
  legend: {
    enabled: true,
    toggleSeries: false
...
var ChordSeries = class extends FlowProportionSeries {
  ...
  getBaseNodeStyle(isHighlight, datum) {
    const { properties } = this;
  ...
  updateNodeNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      applyShapeStyle7(sector, format, overrides, fillBBox);
  ...
  getBaseLinkStyle(isHighlight, datum) {
    const { properties } = this;
  ...
  updateLinkNodes(opts) {
    ...
    datumSelection.each((link, datum) => {
      ...
      applyShapeStyle7(link, style, overrides, fillBBox);
...
var ChordModule = {
  ...
  themeTemplate: {
    series: {
      ...
      highlight: import_ag_charts_community74._ModuleSupport.singleSeriesHighlightStyle(),
      label: {
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
...
var FUNNEL_SERIES_THEME = {
  series: {
    ...
    highlight: import_ag_charts_community75._ModuleSupport.singleSeriesHighlightStyle()
  },
  axes: {
...
var BaseFunnelSeries = class extends import_ag_charts_community78._ModuleSupport.AbstractBarSeries {
  ...
  updateNodes(highlightedItems, seriesHighlighted, anySeriesItemEnabled, nodeRefresh) {
  ...
  getTooltipContent(datumIndex) {
    ...
    return this.formatTooltipWithContext(
      tooltip,
      {
        ...
        data: [
          {
            label: xAxis.formatDatum(xValue2, "tooltip", seriesId, legendItemName, datum, stageKey),
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { Line: Line4, ChartAxisDirection: ChartAxisDirection13 } = import_ag_charts_community80._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, coneFunnelSeriesThemeableOptionsDef, without: without3 } = import_ag_charts_community81._ModuleSupport;
...
var CONE_FUNNEL_SERIES_THEME = {
  series: {
    ...
    highlight: import_ag_charts_community82._ModuleSupport.singleSeriesHighlightStyle(false)
  },
  seriesArea: {
    padding: {
      top: 20,
...
var FunnelSeries = class extends BaseFunnelSeries {
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      applyShapeStyle9(rect, style, overrides, fillBBox);
      rect.visible = categoryAlongX ? datum.width > 0 : datum.height > 0;
      rect.crisp = datum.crisp;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, funnelSeriesThemeableOptionsDef, without: without4 } = import_ag_charts_community86._ModuleSupport;
...
function formatWithContext(ctx, formatter, params) {
  return import_ag_charts_community88._ModuleSupport.callWithContext(ctx.chartService, formatter, params);
}
...
var { BaseProperties: BaseProperties8, Property: Property24 } = import_ag_charts_community92._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/linear-gauge/linearGaugeSeriesProperties.ts
var { BaseProperties: BaseProperties9, makeSeriesTooltip: makeSeriesTooltip11, SeriesProperties: SeriesProperties2, PropertiesArray: PropertiesArray2, Property: Property25, Label: Label7, AxisLabel: AxisLabel3 } = import_ag_charts_community93._ModuleSupport;
...
var LinearGaugeBarProperties = class extends BaseProperties9 {
  constructor() {
    ...
    this.fills = new PropertiesArray2(import_ag_charts_community93._ModuleSupport.StopProperties);
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, BBox: BBox8 } = import_ag_charts_community94._ModuleSupport;
...
var LinearGaugeSeries = class extends import_ag_charts_community95._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      rect.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community95._ModuleSupport.PointerEvents.All : import_ag_charts_community95._ModuleSupport.PointerEvents.None;
      if (animationDisabled || rect.previousDatum == null) {
        rect.setProperties(resetLinearGaugeSeriesResetRectFunction(rect, datum));
      }
    });
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community95._ModuleSupport.Rect, (node, first, last) => {
      node.pointerEvents = import_ag_charts_community95._ModuleSupport.PointerEvents.None;
  ...
  themeTemplate: {
    ...
    series: {
      ...
      label: {
        ...
        fontWeight: { $ref: "fontWeight" },
        fontSize: { $rem: 2 },
        minimumFontSize: import_ag_charts_community96._ModuleSupport.FONT_SIZE.SMALL,
        spacing: 18,
        color: { $ref: "chartBackgroundColor" }
      },
      margin: 4,
...
var LinearGaugeSeriesModule = {
  ...
  chartType: "gauge",
  enterprise: true,
  options: import_ag_charts_community96._ModuleSupport.linearGaugeSeriesOptionsDef,
...
function applyMapPalette(object) {
  const clone = import_ag_charts_community97._ModuleSupport.deepClone(object);
  import_ag_charts_community97._ModuleSupport.jsonWalk(clone, (value) => {
...
var { LonLatBBox } = import_ag_charts_community98._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path8, ExtendedPath2D: ExtendedPath2D2, BBox: BBox10, SceneChangeDetection: SceneChangeDetection5, SceneObjectChangeDetection, objectsEqual } = import_ag_charts_community99._ModuleSupport;
...
var { LonLatBBox: LonLatBBox2 } = import_ag_charts_community100._ModuleSupport;
...
var TopologySeriesProperties = class extends import_ag_charts_community101._ModuleSupport.SeriesProperties {
};
var TopologySeries = class extends import_ag_charts_community101._ModuleSupport.DataModelSeries {
...
var { Property: Property26, SeriesProperties: SeriesProperties3, makeSeriesTooltip: makeSeriesTooltip12, Label: Label8 } = import_ag_charts_community102._ModuleSupport;
...
var MapLineSeries = class extends TopologySeries {
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community103._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs11, mapLineSeriesThemeableOptionsDef, without: without5 } = import_ag_charts_community104._ModuleSupport;
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: applyMapPalette(import_ag_charts_community105._ModuleSupport.SAFE_STROKE_FILL_OPERATION),
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community105._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      strokeWidth: 1,
      maxStrokeWidth: 3,
      ...
      highlight: applyMapPalette(import_ag_charts_community105._ModuleSupport.multiSeriesHighlightStyle(false))
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property27, SeriesProperties: SeriesProperties4, makeSeriesTooltip: makeSeriesTooltip13 } = import_ag_charts_community106._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId14, SeriesNodePickMode: SeriesNodePickMode10, Group: Group9, Selection: Selection8, PointerEvents: PointerEvents6 } = import_ag_charts_community107._ModuleSupport;
...
var { mapLineBackgroundSeriesThemeableOptionsDef } = import_ag_charts_community108._ModuleSupport;
...
var { BBox: BBox11 } = import_ag_charts_community110._ModuleSupport;
...
var MapMarkerSeries = class extends TopologySeries {
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community112._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
  ...
  updateMarkerNodes(opts) {
    ...
    markerSelection.each((marker, markerDatum) => {
      ...
      applyShapeStyle10(marker, style, overrides, fillBBox);
      marker.x = point.x;
      marker.y = point.y;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, mapMarkerSeriesThemeableOptionsDef, without: without6 } = import_ag_charts_community113._ModuleSupport;
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community114._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: applyMapPalette(import_ag_charts_community114._ModuleSupport.FILL_PATTERN_DEFAULTS),
      fillImageDefaults: applyMapPalette(import_ag_charts_community114._ModuleSupport.FILL_IMAGE_DEFAULTS),
      fillOpacity: 0.5,
      label: {
        enabled: false,
        fontSize: { $ref: "fontSize" },
...
var { Property: Property29, SeriesProperties: SeriesProperties6, makeSeriesTooltip: makeSeriesTooltip15, FillGradientDefaults: FillGradientDefaults10, FillPatternDefaults: FillPatternDefaults10, FillImageDefaults: FillImageDefaults10 } = import_ag_charts_community115._ModuleSupport;
...
var fixedScale = import_ag_charts_community116._ModuleSupport.MercatorScale.fixedScale();
var MapShapeSeries = class extends TopologySeries {
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((geoGeometry, nodeDatum) => {
      ...
      geoGeometry.visible = true;
      geoGeometry.projectedGeometry = projectedGeometry;
      applyShapeStyle11(geoGeometry, style, overrides, fillBBox);
    });
  }
  updateLabelSelection(opts) {
    const labels = this.isLabelEnabled() ? opts.labelData : [];
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, mapShapeSeriesThemeableOptionsDef, without: without7 } = import_ag_charts_community117._ModuleSupport;
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community118._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: applyMapPalette(import_ag_charts_community118._ModuleSupport.FILL_PATTERN_DEFAULTS),
      fillImageDefaults: applyMapPalette(import_ag_charts_community118._ModuleSupport.FILL_IMAGE_DEFAULTS),
      fillOpacity: 1,
      strokeWidth: 1,
      lineDash: [0],
      lineDashOffset: 0,
      ...
      highlight: applyMapPalette(import_ag_charts_community118._ModuleSupport.multiSeriesHighlightStyle())
    },
    tooltip: {
      range: "exact"
    }
...
var { FillGradientDefaults: FillGradientDefaults11, FillPatternDefaults: FillPatternDefaults11, FillImageDefaults: FillImageDefaults11, Property: Property30, SeriesProperties: SeriesProperties7, makeSeriesTooltip: makeSeriesTooltip16 } = import_ag_charts_community119._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId17, SeriesNodePickMode: SeriesNodePickMode13, Selection: Selection11, Group: Group12, PointerEvents: PointerEvents8, getShapeStyle: getShapeStyle12 } = import_ag_charts_community120._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, mapShapeBackgroundSeriesThemeableOptionsDef } = import_ag_charts_community121._ModuleSupport;
...
var MapShapeBackgroundModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: {
        ...applyMapPalette(import_ag_charts_community122._ModuleSupport.FILL_PATTERN_DEFAULTS),
        fill: { $path: ["/1", { $mapPalette: "fill" }, { $mapPalette: "hierarchyColors" }] },
        stroke: { $path: ["/1", { $mapPalette: "fill" }, { $mapPalette: "hierarchyColors" }] }
      },
      fillImageDefaults: applyMapPalette(import_ag_charts_community122._ModuleSupport.FILL_IMAGE_DEFAULTS)
    }
  }
};
...
var RadialColumnSeriesNodeEvent = class extends import_ag_charts_community123._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community123._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  updateSectorSelection(selection, isHighlight) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      applyShapeStyle12(node, style, overrides, fillBBox, fillParams);
  ...
  getTooltipContent(datumIndex) {
    ...
    return this.formatTooltipWithContext(
      tooltip,
      {
        heading: angleAxis.formatDatum(angleValue, "tooltip", seriesId, void 0, datum, angleKey),
        symbol: this.legendItemSymbol(),
        data: [
          {
            label: radiusName,
            fallbackLabel: radiusKey,
            value: radiusAxis.formatDatum(radiusValue, "tooltip", seriesId, void 0, datum, radiusKey)
          }
        ]
      },
      {
  ...
  legendItemSymbol() {
    ...
    if (import_ag_charts_community123._ModuleSupport.isGradientFill(markerStyle.fill)) {
...
var { motion: motion7 } = import_ag_charts_community125._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = import_ag_charts_community126._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = import_ag_charts_community127._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = import_ag_charts_community128._ModuleSupport;
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community129._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community129._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: 1,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
    ...
    highlight: import_ag_charts_community129._ModuleSupport.multiSeriesHighlightStyle()
  },
  axes: {
...
var PyramidSeries = class extends import_ag_charts_community132._ModuleSupport.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((connector, nodeDatum) => {
      ...
      applyShapeStyle13(connector, style, overrides, fillBBox);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = import_ag_charts_community133._ModuleSupport;
...
var PYRAMID_SERIES_THEME = {
  series: {
    ...
    fillImageDefaults: import_ag_charts_community134._ModuleSupport.FILL_IMAGE_DEFAULTS,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
    ...
    highlight: import_ag_charts_community134._ModuleSupport.singleSeriesHighlightStyle()
  }
};
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    ...
    marker: {
      ...
      fillPatternDefaults: import_ag_charts_community136._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community136._ModuleSupport.FILL_IMAGE_DEFAULTS,
      fillOpacity: 1,
      shape: "circle",
      size: 6,
      strokeOpacity: 1,
    ...
    highlight: import_ag_charts_community136._ModuleSupport.multiSeriesHighlightStyle(),
    tooltip: {
      range: { $path: ["/tooltip/range", "nearest"] }
    }
  },
...
var RADAR_LINE_SERIES_THEME = import_ag_charts_community136._ModuleSupport.mergeDefaults(
  {
    series: {
      stroke: import_ag_charts_community136._ModuleSupport.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = import_ag_charts_community136._ModuleSupport.mergeDefaults(
  {
    series: {
      fill: { $palette: "fill" },
      fillGradientDefaults: {
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, makeSeriesTooltip: makeSeriesTooltip19, Property: Property33 } = import_ag_charts_community137._ModuleSupport;
...
var RadarSeriesNodeEvent = class extends import_ag_charts_community138._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community138._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
  ...
  updateMarkers(selection, isHighlight) {
    ...
    selection.update(selectionData).each((node, datum) => {
      const highlightStyle = this.getHighlightStyle(isHighlight, datum.datumIndex);
      const baseStyle = mergeDefaults4(highlightStyle, markerStyle, {
        stroke,
        strokeWidth,
        strokeOpacity
      });
  ...
  updatePathNodes() {
    ...
    if (!lineNode)
      return;
    const { strokeWidth, stroke, strokeOpacity, lineDash, lineDashOffset, opacity } = mergeDefaults4(
...
var { FillGradientDefaults: FillGradientDefaults14, FillPatternDefaults: FillPatternDefaults14, FillImageDefaults: FillImageDefaults14, Property: Property34 } = import_ag_charts_community139._ModuleSupport;
...
var RadarAreaSeries = class extends RadarSeries {
  ...
  updatePathNodes() {
    ...
    const { fill, fillOpacity, opacity } = mergeDefaults5(this.getHighlightStyle(), this.properties);
    const { fill: seriesFill, fillOpacity: seriesFillOpacity } = getShapeStyle16(
      { fill, fillOpacity },
      this.properties.fillGradientDefaults,
      this.properties.fillPatternDefaults,
      this.properties.fillImageDefaults
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof import_ag_charts_community140._ModuleSupport.PolarAxis ? axis : void 0;
    };
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = import_ag_charts_community141._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = import_ag_charts_community143._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = import_ag_charts_community144._ModuleSupport.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { SectorBox: SectorBox3, motion: motion9 } = import_ag_charts_community146._ModuleSupport;
...
var RadialBarSeriesNodeEvent = class extends import_ag_charts_community147._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community147._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  get defaultShapeStyle() {
    ...
    return {
      ...
      rotation: import_ag_charts_community147._ModuleSupport.toDegrees(angleScale.range[0]) + 90
    };
  }
  nodeFactory() {
    return new Sector5();
  ...
  updateSectorSelection(selection, isHighlight) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = overrides?.fill ?? style.fill;
      const fillParams = import_ag_charts_community147._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
      applyShapeStyle15(node, style, overrides, fillBBox, fillParams);
      node.lineJoin = "round";
  ...
  getTooltipContent(datumIndex) {
    ...
    return this.formatTooltipWithContext(
      tooltip,
      {
        heading: radiusAxis.formatDatum(radiusValue, "tooltip", seriesId, void 0, datum, radiusKey),
        symbol: this.legendItemSymbol(),
        data: [
          {
            label: angleName,
            fallbackLabel: angleKey,
            value: angleAxis.formatDatum(angleValue, "tooltip", seriesId, void 0, datum, angleKey)
          }
        ]
      },
      {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = import_ag_charts_community148._ModuleSupport;
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community149._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community149._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = import_ag_charts_community150._ModuleSupport.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property36 } = import_ag_charts_community151._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection19, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community152._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = import_ag_charts_community153._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = import_ag_charts_community155._ModuleSupport.ThemeConstants;
...
var { SvgPath, Rotatable, Translatable, Scalable } = import_ag_charts_community156._ModuleSupport;
...
var { BaseProperties: BaseProperties10, makeSeriesTooltip: makeSeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property37, Label: Label14 } = import_ag_charts_community157._ModuleSupport;
...
var RadialGaugeBarProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(import_ag_charts_community157._ModuleSupport.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
var { SectorBox: SectorBox5 } = import_ag_charts_community158._ModuleSupport;
...
var RadialGaugeSeries = class extends import_ag_charts_community159._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    this.tickSelection = Selection15.select(this.tickGroup, import_ag_charts_community159._ModuleSupport.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community159._ModuleSupport.PointerEvents.All : import_ag_charts_community159._ModuleSupport.PointerEvents.None;
      sector.fill = fill;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community159._ModuleSupport.Sector, (node, first, last) => {
      ...
      node.pointerEvents = import_ag_charts_community159._ModuleSupport.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = import_ag_charts_community160._ModuleSupport;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          import_ag_charts_community160._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["/1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["/2", import_ag_charts_community160._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          fontWeight: { $ref: "fontWeight" },
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "gauge",
  enterprise: true,
  options: import_ag_charts_community160._ModuleSupport.radialGaugeSeriesOptionsDef,
...
var { BBox: BBox15, Path: Path11, SceneChangeDetection: SceneChangeDetection6, splitBezier2D } = import_ag_charts_community161._ModuleSupport;
...
var SankeySeries = class extends FlowProportionSeries {
  ...
  updateNodeNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      applyShapeStyle16(rect, style, overrides, fillBBox);
    });
  }
  getShapeFillBBox() {
    const width = this._nodeDataDependencies?.seriesRectWidth ?? 0;
  ...
  updateLinkNodes(opts) {
    ...
    datumSelection.each((link, datum) => {
      ...
      applyShapeStyle16(link, style, overrides, fillBBox);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = import_ag_charts_community164._ModuleSupport;
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community165._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community165._ModuleSupport.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: import_ag_charts_community165._ModuleSupport.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      ...
      highlight: {
        ...import_ag_charts_community165._ModuleSupport.singleSeriesHighlightStyle()
      },
      label: {
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
...
var { HierarchySeriesProperties, HighlightStyle, makeSeriesTooltip: makeSeriesTooltip23, Property: Property39 } = import_ag_charts_community166._ModuleSupport;
...
var SunburstNode = class extends import_ag_charts_community167._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends import_ag_charts_community167._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  updateNodes() {
    ...
    const updateSector = (nodeDatum, sector, style, highlighted) => {
      ...
      const fillBBox = import_ag_charts_community167._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
      applyShapeStyle17(sector, style, overrides, fillBBox);
      sector.centerX = 0;
      sector.centerY = 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community167._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without8 } = import_ag_charts_community168._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { BASE_FONT_SIZE, FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = import_ag_charts_community169._ModuleSupport;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community169._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community169._ModuleSupport.FILL_IMAGE_DEFAULTS,
      strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
      label: {
        fontFamily: { $ref: "fontFamily" },
...
var { BaseProperties: BaseProperties12, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, makeSeriesTooltip: makeSeriesTooltip24, Property: Property40, Label: Label16 } = import_ag_charts_community170._ModuleSupport;
...
var TreemapNode = class extends import_ag_charts_community171._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends import_ag_charts_community171._ModuleSupport.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends import_ag_charts_community171._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  updateNodes() {
    ...
    const updateRectFn = (node, rect, groupStyle, tileStyle, highlighted) => {
      ...
      rect.crisp = true;
      applyShapeStyle18(rect, style, overrides, fillBBox);
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community171._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without9 } = import_ag_charts_community172._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = import_ag_charts_community173._ModuleSupport;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community173._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community173._ModuleSupport.FILL_IMAGE_DEFAULTS,
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = import_ag_charts_community174._ModuleSupport.ModuleRegistry;
