  ...
  series: {
    ...
    fill: {
      $if: [
        ...
        { $palette: "fill" },
        { $mix: [_ModuleSupport29.SAFE_FILL_OPERATION, { $ref: "chartBackgroundColor" }, 0.7] }
      ]
    },
...
var { BaseProperties: BaseProperties3, Property: Property14, AbstractBarSeriesProperties: AbstractBarSeriesProperties2, makeSeriesTooltip: makeSeriesTooltip2 } = _ModuleSupport35;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeriesProperties.ts
var { FillGradientDefaults: FillGradientDefaults2, FillPatternDefaults: FillPatternDefaults2, FillImageDefaults: FillImageDefaults2, BaseProperties: BaseProperties4, makeSeriesTooltip: makeSeriesTooltip3, Property: Property15 } = _ModuleSupport36;
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeriesProperties.ts
var { CartesianSeriesProperties, makeSeriesTooltip: makeSeriesTooltip4, Property: Property17 } = _ModuleSupport43;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, heatmapSeriesThemeableOptionsDef, without } = _ModuleSupport45;
...
var HEATMAP_SERIES_THEME = {
  series: {
    ...
    itemPadding: 3,
    highlight: _ModuleSupport46.singleSeriesHighlightStyle()
  },
  gradientLegend: {
    enabled: true
  }
...
var { createDatumId: createDatumId5, applyShapeStyle: applyShapeStyle3 } = _ModuleSupport48;
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    highlight: _ModuleSupport60.multiSeriesHighlightStyle()
  },
  axes: {
...
var WATERFALL_SERIES_THEME = {
  series: {
    ...
    highlight: _ModuleSupport65.singleSeriesHighlightStyle()
  },
  legend: {
    enabled: true,
    toggleSeries: false
...
var ChordModule = {
  ...
  themeTemplate: {
    series: {
      ...
      highlight: _ModuleSupport74.singleSeriesHighlightStyle(),
      label: {
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
...
var FUNNEL_SERIES_THEME = {
  series: {
    ...
    highlight: _ModuleSupport75.singleSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { Line: Line4, ChartAxisDirection: ChartAxisDirection13 } = _ModuleSupport80;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, coneFunnelSeriesThemeableOptionsDef, without: without3 } = _ModuleSupport81;
...
var CONE_FUNNEL_SERIES_THEME = {
  series: {
    ...
    highlight: _ModuleSupport82.singleSeriesHighlightStyle(false)
  },
  seriesArea: {
    padding: {
      top: 20,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, funnelSeriesThemeableOptionsDef, without: without4 } = _ModuleSupport86;
...
function formatWithContext(ctx, formatter, params) {
  return _ModuleSupport88.callWithContext(ctx.chartService, formatter, params);
}
...
var { BaseProperties: BaseProperties8, Property: Property24 } = _ModuleSupport91;
...
// packages/ag-charts-enterprise/src/series/linear-gauge/linearGaugeSeriesProperties.ts
var { BaseProperties: BaseProperties9, makeSeriesTooltip: makeSeriesTooltip11, SeriesProperties: SeriesProperties2, PropertiesArray: PropertiesArray2, Property: Property25, Label: Label7, AxisLabel: AxisLabel3 } = _ModuleSupport92;
...
var LinearGaugeBarProperties = class extends BaseProperties9 {
  constructor() {
    ...
    this.fills = new PropertiesArray2(_ModuleSupport92.StopProperties);
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, BBox: BBox8 } = _ModuleSupport93;
...
var LinearGaugeSeries = class extends _ModuleSupport94.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      rect.pointerEvents = this.properties.bar.enabled ? _ModuleSupport94.PointerEvents.All : _ModuleSupport94.PointerEvents.None;
      if (animationDisabled || rect.previousDatum == null) {
        rect.setProperties(resetLinearGaugeSeriesResetRectFunction(rect, datum));
      }
    });
    this.datumUnion.update(datumSelection, this.itemGroup, _ModuleSupport94.Rect, (node, first, last) => {
      node.pointerEvents = _ModuleSupport94.PointerEvents.None;
  ...
  themeTemplate: {
    ...
    series: {
      ...
      label: {
        ...
        fontWeight: { $ref: "fontWeight" },
        fontSize: { $rem: 2 },
        minimumFontSize: _ModuleSupport95.FONT_SIZE.SMALL,
        spacing: 18,
        color: { $ref: "chartBackgroundColor" }
      },
      margin: 4,
...
var LinearGaugeSeriesModule = {
  ...
  chartType: "gauge",
  enterprise: true,
  options: _ModuleSupport95.linearGaugeSeriesOptionsDef,
...
function applyMapPalette(object) {
  const clone = _ModuleSupport96.deepClone(object);
  _ModuleSupport96.jsonWalk(clone, (value) => {
...
var { LonLatBBox } = _ModuleSupport97;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path8, ExtendedPath2D: ExtendedPath2D2, BBox: BBox10, SceneChangeDetection: SceneChangeDetection5, SceneObjectChangeDetection, objectsEqual } = _ModuleSupport98;
...
var { LonLatBBox: LonLatBBox2 } = _ModuleSupport99;
...
var TopologySeriesProperties = class extends _ModuleSupport100.SeriesProperties {
};
var TopologySeries = class extends _ModuleSupport100.DataModelSeries {
...
var { Property: Property26, SeriesProperties: SeriesProperties3, makeSeriesTooltip: makeSeriesTooltip12, Label: Label8 } = _ModuleSupport101;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs11, mapLineSeriesThemeableOptionsDef, without: without5 } = _ModuleSupport103;
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: applyMapPalette(_ModuleSupport104.SAFE_STROKE_FILL_OPERATION),
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
      ...
      highlight: applyMapPalette(_ModuleSupport104.multiSeriesHighlightStyle(false))
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property27, SeriesProperties: SeriesProperties4, makeSeriesTooltip: makeSeriesTooltip13 } = _ModuleSupport105;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId14, SeriesNodePickMode: SeriesNodePickMode10, Group: Group9, Selection: Selection8, PointerEvents: PointerEvents6 } = _ModuleSupport106;
...
var { mapLineBackgroundSeriesThemeableOptionsDef } = _ModuleSupport107;
...
var { BBox: BBox11 } = _ModuleSupport109;
...
var MapMarkerSeries = class extends TopologySeries {
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = _ModuleSupport111.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, mapMarkerSeriesThemeableOptionsDef, without: without6 } = _ModuleSupport112;
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(_ModuleSupport113.SAFE_RANGE2_OPERATION)
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: applyMapPalette(_ModuleSupport113.FILL_PATTERN_DEFAULTS),
      fillImageDefaults: applyMapPalette(_ModuleSupport113.FILL_IMAGE_DEFAULTS),
      fillOpacity: 0.5,
      label: {
        enabled: false,
        fontSize: { $ref: "fontSize" },
      ...
      highlight: applyMapPalette(_ModuleSupport113.multiSeriesHighlightStyle())
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property29, SeriesProperties: SeriesProperties6, makeSeriesTooltip: makeSeriesTooltip15, FillGradientDefaults: FillGradientDefaults10, FillPatternDefaults: FillPatternDefaults10, FillImageDefaults: FillImageDefaults10 } = _ModuleSupport114;
...
var fixedScale = _ModuleSupport115.MercatorScale.fixedScale();
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, mapShapeSeriesThemeableOptionsDef, without: without7 } = _ModuleSupport116;
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(_ModuleSupport117.SAFE_RANGE2_OPERATION)
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: applyMapPalette(_ModuleSupport117.FILL_PATTERN_DEFAULTS),
      fillImageDefaults: applyMapPalette(_ModuleSupport117.FILL_IMAGE_DEFAULTS),
      fillOpacity: 1,
      strokeWidth: 1,
      lineDash: [0],
      lineDashOffset: 0,
      ...
      highlight: applyMapPalette(_ModuleSupport117.multiSeriesHighlightStyle())
    },
    tooltip: {
      range: "exact"
    }
...
var { FillGradientDefaults: FillGradientDefaults11, FillPatternDefaults: FillPatternDefaults11, FillImageDefaults: FillImageDefaults11, Property: Property30, SeriesProperties: SeriesProperties7, makeSeriesTooltip: makeSeriesTooltip16 } = _ModuleSupport118;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId17, SeriesNodePickMode: SeriesNodePickMode13, Selection: Selection11, Group: Group12, PointerEvents: PointerEvents8, getShapeStyle: getShapeStyle12 } = _ModuleSupport119;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, mapShapeBackgroundSeriesThemeableOptionsDef } = _ModuleSupport120;
...
var MapShapeBackgroundModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: {
        ...applyMapPalette(_ModuleSupport121.FILL_PATTERN_DEFAULTS),
        fill: { $path: ["/1", { $mapPalette: "fill" }, { $mapPalette: "hierarchyColors" }] },
        stroke: { $path: ["/1", { $mapPalette: "fill" }, { $mapPalette: "hierarchyColors" }] }
      },
      fillImageDefaults: applyMapPalette(_ModuleSupport121.FILL_IMAGE_DEFAULTS)
    }
  }
};
...
var RadialColumnSeriesNodeEvent = class extends _ModuleSupport122.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends _ModuleSupport122.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  legendItemSymbol() {
    ...
    if (_ModuleSupport122.isGradientFill(markerStyle.fill)) {
...
var { motion: motion7 } = _ModuleSupport124;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = _ModuleSupport125;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = _ModuleSupport126;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = _ModuleSupport127;
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: _ModuleSupport128.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport128.FILL_IMAGE_DEFAULTS,
    strokeWidth: 1,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
    ...
    highlight: _ModuleSupport128.multiSeriesHighlightStyle()
  },
  axes: {
...
import {
  _ModuleSupport as _ModuleSupport131
} from "ag-charts-community";
...
var PyramidSeries = class extends _ModuleSupport131.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = _ModuleSupport132;
...
var PYRAMID_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: _ModuleSupport133.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport133.FILL_IMAGE_DEFAULTS,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
    ...
    highlight: _ModuleSupport133.singleSeriesHighlightStyle()
  }
};
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    ...
    marker: {
      ...
      fillPatternDefaults: _ModuleSupport135.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport135.FILL_IMAGE_DEFAULTS,
      fillOpacity: 1,
      shape: "circle",
      size: 6,
      strokeOpacity: 1,
    ...
    highlight: _ModuleSupport135.multiSeriesHighlightStyle(),
    tooltip: {
      range: { $path: ["/tooltip/range", "nearest"] }
    }
  },
...
var RADAR_LINE_SERIES_THEME = _ModuleSupport135.mergeDefaults(
  {
    series: {
      stroke: _ModuleSupport135.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = _ModuleSupport135.mergeDefaults(
  {
    series: {
      fill: { $palette: "fill" },
      fillGradientDefaults: {
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, makeSeriesTooltip: makeSeriesTooltip19, Property: Property33 } = _ModuleSupport136;
...
var RadarSeriesNodeEvent = class extends _ModuleSupport137.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends _ModuleSupport137.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
...
var { FillGradientDefaults: FillGradientDefaults14, FillPatternDefaults: FillPatternDefaults14, FillImageDefaults: FillImageDefaults14, Property: Property34 } = _ModuleSupport138;
...
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof _ModuleSupport139.PolarAxis ? axis : void 0;
    };
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = _ModuleSupport140;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = _ModuleSupport142;
...
// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = _ModuleSupport143.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { SectorBox: SectorBox3, motion: motion9 } = _ModuleSupport145;
...
var RadialBarSeries = class extends _ModuleSupport146.PolarSeries {
  ...
  get defaultShapeStyle() {
    ...
    return {
      ...
      rotation: _ModuleSupport146.toDegrees(angleScale.range[0]) + 90
    };
  }
  nodeFactory() {
    return new Sector5();
  ...
  updateSectorSelection(selection, isHighlight) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = overrides?.fill ?? style.fill;
      const fillParams = _ModuleSupport146.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = _ModuleSupport147;
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: _ModuleSupport148.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport148.FILL_IMAGE_DEFAULTS,
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
    ...
    highlight: _ModuleSupport148.multiSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = _ModuleSupport149.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property36 } = _ModuleSupport150;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection19, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = _ModuleSupport151;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = _ModuleSupport152;
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    highlight: _ModuleSupport153.multiSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = _ModuleSupport154.ThemeConstants;
...
var { SvgPath, Rotatable, Translatable, Scalable } = _ModuleSupport155;
...
import "ag-charts-core";
var { BaseProperties: BaseProperties10, makeSeriesTooltip: makeSeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property37, Label: Label14 } = _ModuleSupport156;
...
var RadialGaugeBarProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(_ModuleSupport156.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
var { SectorBox: SectorBox5 } = _ModuleSupport157;
...
var RadialGaugeSeries = class extends _ModuleSupport158.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    this.tickSelection = Selection15.select(this.tickGroup, _ModuleSupport158.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? _ModuleSupport158.PointerEvents.All : _ModuleSupport158.PointerEvents.None;
      sector.fill = fill;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, _ModuleSupport158.Sector, (node, first, last) => {
      ...
      node.pointerEvents = _ModuleSupport158.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = _ModuleSupport159;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          _ModuleSupport159.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["/1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["/2", _ModuleSupport159.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          fontWeight: { $ref: "fontWeight" },
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "gauge",
  enterprise: true,
  options: _ModuleSupport159.radialGaugeSeriesOptionsDef,
...
var { BBox: BBox15, Path: Path11, SceneChangeDetection: SceneChangeDetection6, splitBezier2D } = _ModuleSupport160;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = _ModuleSupport163;
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: _ModuleSupport164.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport164.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: _ModuleSupport164.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      ...
      highlight: {
        ..._ModuleSupport164.singleSeriesHighlightStyle()
      },
      label: {
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
...
var { HierarchySeriesProperties, HighlightStyle, makeSeriesTooltip: makeSeriesTooltip23, Property: Property39 } = _ModuleSupport165;
...
var SunburstNode = class extends _ModuleSupport166.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends _ModuleSupport166.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  updateNodes() {
    ...
    const updateSector = (nodeDatum, sector, style, highlighted) => {
      ...
      const fillBBox = _ModuleSupport166.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport166.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without8 } = _ModuleSupport167;
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { BASE_FONT_SIZE, FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = _ModuleSupport168;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: _ModuleSupport168.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport168.FILL_IMAGE_DEFAULTS,
      strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
      label: {
        fontFamily: { $ref: "fontFamily" },
...
import {
  _ModuleSupport as _ModuleSupport170
} from "ag-charts-community";
...
var { BaseProperties: BaseProperties12, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, makeSeriesTooltip: makeSeriesTooltip24, Property: Property40, Label: Label16 } = _ModuleSupport169;
...
var TreemapNode = class extends _ModuleSupport170.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends _ModuleSupport170.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends _ModuleSupport170.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport170.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without9 } = _ModuleSupport171;
...
// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = _ModuleSupport172;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: _ModuleSupport172.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport172.FILL_IMAGE_DEFAULTS,
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = _ModuleSupport173.ModuleRegistry;
