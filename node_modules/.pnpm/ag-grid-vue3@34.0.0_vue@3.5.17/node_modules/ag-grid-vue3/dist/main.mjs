...
import { defineComponent as k, createVNode as U, render as T, toRaw as x, isRef as _, isReactive as j, isProxy as q, mergeModels as M, mergeDefaults as $, useTemplateRef as K, ref as g, toRefs as Q, watch as O, useModel as Y, getCurrentInstance as F, onMounted as J, markRaw as X, onUnmounted as Z, openBlock as ee, createElementBlock as ne } from "vue";
import { _error as A, BaseComponentWrapper as oe, _warn as de, VanillaFrameworkOverrides as te, _GET_ALL_GRID_OPTIONS as H, _processOnChange as ie, _registerModule as ae, RowApiModule as re, _combineAttributesAndGridOptions as le, _PUBLIC_EVENT_HANDLERS_MAP as ue, createGrid as se, ALWAYS_SYNC_GLOBAL_EVENTS as pe } from "ag-grid-community";
class v {
  static getComponentDefinition(d, e) {
    let n;
    return typeof d == "string" ? n = this.searchForComponentInstance(e, d) : n = { extends: k({ ...d }) }, n || A(114, { component: d }), n.extends ? (n.extends.setup && (n.setup = n.extends.setup), n.extends.props = this.addParamsToProps(n.extends.props)) : n.props = this.addParamsToProps(n.props), n;
  }
...
const he = { ref: "root" }, Se = /* @__PURE__ */ k({
  __name: "AgGridVue",
  props: /* @__PURE__ */ M(/* @__PURE__ */ $({
    gridOptions: {},
    modules: {},
    statusBar: {},
  ...
  setup(r, { expose: d, emit: e }) {
    const n = r, s = K("root"), t = g(void 0), l = g(!1), o = g(!1), i = g(!1), p = g({}), c = g(null), S = Q(n);
    H().filter((a) => a != "gridOptions").forEach((a) => {
      O(
        () => S[a],
        (u, f) => {
    ...
    const h = /* @__PURE__ */ new Set(["rowDataUpdated", "cellValueChanged", "rowValueChanged"]), m = Y(r, "modelValue"), B = g(!1), w = g(!1), E = e;
    O(
      m,
      (a, u) => {
        l.value && (w.value || (B.value = !0, P("rowData", R(a), R(u))), w.value = !1);
      },
      { deep: !0 }
    );
    const G = Ce(() => {
      ...
      const f = pe.has(u);
      f && !a || !f && a || h.has(u) && (B.value || I(u), B.value = !1);
    }, P = (a, u, f) => {
      if (l.value) {
        let y = u.value || u;
    ...
    }, z = () => Object.create(F().provides);
    return J(() => {
      ae(re, void 0, !0);
      const a = new fe(F(), z()), u = {
        globalListener: b(),
